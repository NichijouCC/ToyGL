...
namespace web3d
{
    ...
    export class ParsePrimitiveNode
    {
        ...
        private static _vertexAttDic:{[type:string]:{type:VertexAttTypeEnum,location:number}}={};
         ...
         */
        static get vertexAttMap():{[type:string]:{type:VertexAttTypeEnum,location:number}}
        {
            if(!this.beinit)
            {
                this._vertexAttDic["POSITION"]={type:VertexAttTypeEnum.Position,location:webGraph.VertexAttLocationEnum.Position};
                this._vertexAttDic["NORMAL"]={type:VertexAttTypeEnum.Normal,location:webGraph.VertexAttLocationEnum.Normal};
                this._vertexAttDic["TEXCOORD_0"]={type:VertexAttTypeEnum.UV0,location:webGraph.VertexAttLocationEnum.UV0};
                this._vertexAttDic["TEXCOORD_1"]={type:VertexAttTypeEnum.UV1,location:webGraph.VertexAttLocationEnum.UV1};
                this._vertexAttDic["COLOR_0"]={type:VertexAttTypeEnum.Color0,location:webGraph.VertexAttLocationEnum.Color0};
                this._vertexAttDic["TANGENT"]={type:VertexAttTypeEnum.Tangent,location:webGraph.VertexAttLocationEnum.Tangent};
                this._vertexAttDic["JOINTS_0"]={type:VertexAttTypeEnum.BlendIndex4,location:webGraph.VertexAttLocationEnum.BlendIndex4};
                this._vertexAttDic["WEIGHTS_0"]={type:VertexAttTypeEnum.BlendWeight4,location:webGraph.VertexAttLocationEnum.BlendWeight4};
                this.beinit=true;
            }
            ...
            }else
            {
                return parseAccessorNode.parse(index,loader).then((node:AccessorNode)=>{
                    ...
                    }else
                    {
                        ...
                        // if(attinfo.type==VertexAttTypeEnum.Normal||attinfo.type==VertexAttTypeEnum.Tangent)
                        // {
